...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "pages_hero_images" DROP CONSTRAINT IF EXISTS "pages_hero_images_image_id_media_id_fk";
  ...
  ALTER TABLE "pages_hero_images" DROP CONSTRAINT IF EXISTS "pages_hero_images_parent_id_fk";
  ...
  ALTER TABLE "pages_hero_social_proof_avatars" DROP CONSTRAINT IF EXISTS "pages_hero_social_proof_avatars_avatar_id_media_id_fk";
  ...
  ALTER TABLE "pages_hero_social_proof_avatars" DROP CONSTRAINT IF EXISTS "pages_hero_social_proof_avatars_parent_id_fk";
  ...
  ALTER TABLE "pages_blocks_vacancies_block" DROP CONSTRAINT IF EXISTS "pages_blocks_vacancies_block_parent_id_fk";
  ...
  ALTER TABLE "pages_blocks_usp_block_gallery" DROP CONSTRAINT IF EXISTS "pages_blocks_usp_block_gallery_image_id_media_id_fk";
  ...
  ALTER TABLE "pages_blocks_usp_block_gallery" DROP CONSTRAINT IF EXISTS "pages_blocks_usp_block_gallery_parent_id_fk";
  ...
  ALTER TABLE "pages_blocks_usp_block_columns_items" DROP CONSTRAINT IF EXISTS "pages_blocks_usp_block_columns_items_parent_id_fk";
  ...
  ALTER TABLE "pages_blocks_usp_block_columns" DROP CONSTRAINT IF EXISTS "pages_blocks_usp_block_columns_parent_id_fk";
  ...
  ALTER TABLE "pages_blocks_usp_block" DROP CONSTRAINT IF EXISTS "pages_blocks_usp_block_parent_id_fk";
  ...
  ALTER TABLE "_pages_v_version_hero_images" DROP CONSTRAINT IF EXISTS "_pages_v_version_hero_images_image_id_media_id_fk";
  ...
  ALTER TABLE "_pages_v_version_hero_images" DROP CONSTRAINT IF EXISTS "_pages_v_version_hero_images_parent_id_fk";
  ...
  ALTER TABLE "_pages_v_version_hero_social_proof_avatars" DROP CONSTRAINT IF EXISTS "_pages_v_version_hero_social_proof_avatars_avatar_id_media_id_fk";
  ...
  ALTER TABLE "_pages_v_version_hero_social_proof_avatars" DROP CONSTRAINT IF EXISTS "_pages_v_version_hero_social_proof_avatars_parent_id_fk";
  ...
  ALTER TABLE "_pages_v_blocks_vacancies_block" DROP CONSTRAINT IF EXISTS "_pages_v_blocks_vacancies_block_parent_id_fk";
  ...
  ALTER TABLE "_pages_v_blocks_usp_block_gallery" DROP CONSTRAINT IF EXISTS "_pages_v_blocks_usp_block_gallery_image_id_media_id_fk";
  ...
  ALTER TABLE "_pages_v_blocks_usp_block_gallery" DROP CONSTRAINT IF EXISTS "_pages_v_blocks_usp_block_gallery_parent_id_fk";
  ...
  ALTER TABLE "_pages_v_blocks_usp_block_columns_items" DROP CONSTRAINT IF EXISTS "_pages_v_blocks_usp_block_columns_items_parent_id_fk";
  ...
  ALTER TABLE "_pages_v_blocks_usp_block_columns" DROP CONSTRAINT IF EXISTS "_pages_v_blocks_usp_block_columns_parent_id_fk";
  ...
  ALTER TABLE "_pages_v_blocks_usp_block" DROP CONSTRAINT IF EXISTS "_pages_v_blocks_usp_block_parent_id_fk";
  ...
  ALTER TABLE "users_roles" DROP CONSTRAINT IF EXISTS "users_roles_parent_fk";
  ALTER TABLE "users_roles" ADD CONSTRAINT "users_roles_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "users_tenants_roles" DROP CONSTRAINT IF EXISTS "users_tenants_roles_parent_fk";
  ...
  ALTER TABLE "users_tenants" DROP CONSTRAINT IF EXISTS "users_tenants_parent_id_fk";
  ...
  ALTER TABLE "tenants" DROP CONSTRAINT IF EXISTS "tenants_logo_id_media_id_fk";
  ...
  ALTER TABLE "vacancies" DROP CONSTRAINT IF EXISTS "vacancies_tenant_id_tenants_id_fk";
  ...
  ALTER TABLE "_vacancies_v" DROP CONSTRAINT IF EXISTS "_vacancies_v_parent_id_vacancies_id_fk";
  ...
  ALTER TABLE "_vacancies_v" DROP CONSTRAINT IF EXISTS "_vacancies_v_version_tenant_id_tenants_id_fk";
  ...
  ALTER TABLE "footer_menu_items" DROP CONSTRAINT IF EXISTS "footer_menu_items_parent_id_fk";
  ...
  ALTER TABLE "footer_social_items" DROP CONSTRAINT IF EXISTS "footer_social_items_parent_id_fk";
  ...
  ALTER TABLE "footer_legal_items" DROP CONSTRAINT IF EXISTS "footer_legal_items_parent_id_fk";
  ...
  CREATE INDEX IF NOT EXISTS "pages_hero_social_proof_avatars_order_idx" ON "pages_hero_social_proof_avatars" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_hero_social_proof_avatars_parent_id_idx" ON "pages_hero_social_proof_avatars" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_hero_social_proof_avatars_avatar_idx" ON "pages_hero_social_proof_avatars" USING btree ("avatar_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_vacancies_block_order_idx" ON "pages_blocks_vacancies_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_vacancies_block_parent_id_idx" ON "pages_blocks_vacancies_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_vacancies_block_path_idx" ON "pages_blocks_vacancies_block" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "pages_blocks_usp_block_gallery_order_idx" ON "pages_blocks_usp_block_gallery" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_usp_block_gallery_parent_id_idx" ON "pages_blocks_usp_block_gallery" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_usp_block_gallery_image_idx" ON "pages_blocks_usp_block_gallery" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_usp_block_columns_items_order_idx" ON "pages_blocks_usp_block_columns_items" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_usp_block_columns_items_parent_id_idx" ON "pages_blocks_usp_block_columns_items" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_usp_block_columns_order_idx" ON "pages_blocks_usp_block_columns" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_usp_block_columns_parent_id_idx" ON "pages_blocks_usp_block_columns" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_usp_block_order_idx" ON "pages_blocks_usp_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_usp_block_parent_id_idx" ON "pages_blocks_usp_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_usp_block_path_idx" ON "pages_blocks_usp_block" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_version_hero_social_proof_avatars_order_idx" ON "_pages_v_version_hero_social_proof_avatars" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_version_hero_social_proof_avatars_parent_id_idx" ON "_pages_v_version_hero_social_proof_avatars" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_version_hero_social_proof_avatars_avatar_idx" ON "_pages_v_version_hero_social_proof_avatars" USING btree ("avatar_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_vacancies_block_order_idx" ON "_pages_v_blocks_vacancies_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_vacancies_block_parent_id_idx" ON "_pages_v_blocks_vacancies_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_vacancies_block_path_idx" ON "_pages_v_blocks_vacancies_block" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_usp_block_gallery_order_idx" ON "_pages_v_blocks_usp_block_gallery" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_usp_block_gallery_parent_id_idx" ON "_pages_v_blocks_usp_block_gallery" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_usp_block_gallery_image_idx" ON "_pages_v_blocks_usp_block_gallery" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_usp_block_columns_items_order_idx" ON "_pages_v_blocks_usp_block_columns_items" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_usp_block_columns_items_parent_id_idx" ON "_pages_v_blocks_usp_block_columns_items" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_usp_block_columns_order_idx" ON "_pages_v_blocks_usp_block_columns" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_usp_block_columns_parent_id_idx" ON "_pages_v_blocks_usp_block_columns" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_usp_block_order_idx" ON "_pages_v_blocks_usp_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_usp_block_parent_id_idx" ON "_pages_v_blocks_usp_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_usp_block_path_idx" ON "_pages_v_blocks_usp_block" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "tenants_logo_idx" ON "tenants" USING btree ("logo_id");
  ...
  CREATE INDEX IF NOT EXISTS "vacancies_tenant_idx" ON "vacancies" USING btree ("tenant_id");
  CREATE INDEX IF NOT EXISTS "vacancies_slug_idx" ON "vacancies" USING btree ("slug");
  CREATE INDEX IF NOT EXISTS "vacancies_updated_at_idx" ON "vacancies" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "vacancies_created_at_idx" ON "vacancies" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "vacancies__status_idx" ON "vacancies" USING btree ("_status");
  CREATE INDEX IF NOT EXISTS "_vacancies_v_parent_idx" ON "_vacancies_v" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "_vacancies_v_version_version_tenant_idx" ON "_vacancies_v" USING btree ("version_tenant_id");
  CREATE INDEX IF NOT EXISTS "_vacancies_v_version_version_slug_idx" ON "_vacancies_v" USING btree ("version_slug");
  CREATE INDEX IF NOT EXISTS "_vacancies_v_version_version_updated_at_idx" ON "_vacancies_v" USING btree ("version_updated_at");
  CREATE INDEX IF NOT EXISTS "_vacancies_v_version_version_created_at_idx" ON "_vacancies_v" USING btree ("version_created_at");
  CREATE INDEX IF NOT EXISTS "_vacancies_v_version_version__status_idx" ON "_vacancies_v" USING btree ("version__status");
  CREATE INDEX IF NOT EXISTS "_vacancies_v_created_at_idx" ON "_vacancies_v" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "_vacancies_v_updated_at_idx" ON "_vacancies_v" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "_vacancies_v_latest_idx" ON "_vacancies_v" USING btree ("latest");
  CREATE INDEX IF NOT EXISTS "_vacancies_v_autosave_idx" ON "_vacancies_v" USING btree ("autosave");
  CREATE INDEX IF NOT EXISTS "footer_menu_items_order_idx" ON "footer_menu_items" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "footer_menu_items_parent_id_idx" ON "footer_menu_items" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "footer_social_items_order_idx" ON "footer_social_items" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "footer_social_items_parent_id_idx" ON "footer_social_items" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "footer_legal_items_order_idx" ON "footer_legal_items" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "footer_legal_items_parent_id_idx" ON "footer_legal_items" USING btree ("_parent_id");
  CREATE UNIQUE INDEX IF NOT EXISTS "payload_kv_key_idx" ON "payload_kv" USING btree ("key");
  ALTER TABLE "pages_blocks_cta" DROP CONSTRAINT IF EXISTS "pages_blocks_cta_image_id_media_id_fk";
  ...
  ALTER TABLE "_pages_v_blocks_cta" DROP CONSTRAINT IF EXISTS "_pages_v_blocks_cta_image_id_media_id_fk";
  ...
  ALTER TABLE "header" DROP CONSTRAINT IF EXISTS "header_tenant_id_tenants_id_fk";
  ...
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_vacancies_id_idx" ON "payload_locked_documents_rels" USING btree ("vacancies_id");
  ...
  CREATE UNIQUE INDEX IF NOT EXISTS "header_tenant_idx" ON "header" USING btree ("tenant_id");
